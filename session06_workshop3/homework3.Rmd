...
There are well over 28 million entries of individual, de-identified patient data, and the CSV  is more than 3Gb. Since this is a large file, we have made it into an SQLlite database. Given the data we have, I would like you to produce two graphs that show death % rate:
